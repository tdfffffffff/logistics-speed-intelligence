# Logistics Speed Intelligence

An end-to-end analysis of parcel-logistics speed across carriers, routes and time periods for a regional
delivery network, combined with a language model layer that communicates verified findings to six operational audiences and a
...
# 2. Open the analysis
jupyter lab logistics_speed_intelligence.ipynb
...
| Generated manager brief | `Insight_Brief.docx`, produced by Section 16 |
...
logistics-speed-intelligence/
│
├── logistics_speed_intelligence.ipynb   # Main analysis
├── README.md                                              # This document
├── Insight_Brief.docx                                 # Manager brief, generated by Section 16
├── app.py                                                 # Prototype launcher
├── requirements.txt                                       # Dependencies
├── .env.example                                           # API key template
│
├── speedlab/
│   ├── config.py                # Paths and the analysis specification encoded as constants
